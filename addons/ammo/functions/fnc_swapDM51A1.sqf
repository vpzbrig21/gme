 ...
 *
 *  Example:
 *      [_player, "removeFrag"] call gme_ammo_fnc_swapDM51A1
 *
 */
...
if (_typeOfSwap isEqualTo "removeFrag") then {
    _itemToAdd = "gm_handgrenade_conc_dm51a1";
    _itemToRemove = "gm_handgrenade_frag_dm51a1";
    _text = localize "STR_GME_AMMO_REMOVEFRAG";
} else {
    _itemToAdd = "gm_handgrenade_frag_dm51a1";
    _itemToRemove = "gm_handgrenade_conc_dm51a1";
