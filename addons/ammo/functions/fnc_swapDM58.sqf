 ...
 *
 *  Example:
 *      [_player, "removeFrag"] call gme_ammo_fnc_swapDM58
 *
 */
...
if (_typeOfSwap isEqualTo "removeFrag") then {
    _itemToAdd = "gm_handgrenade_pracconc_dm58";
    _itemToRemove = "gm_handgrenade_pracfrag_dm58";
    _text = localize "STR_GME_AMMO_REMOVEFRAG";
} else {
    _itemToAdd = "gm_handgrenade_pracfrag_dm58";
    _itemToRemove = "gm_handgrenade_pracconc_dm58";
